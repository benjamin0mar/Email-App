...
class EventosControllerTest < ActionController::TestCase
  ...
  test "should create evento" do
    assert_difference('Evento.count') do
      post :create, evento: { contenido: @evento.contenido, titulo: @evento.titulo, usuario_id: @evento.usuario_id }
    end
  ...
  test "should update evento" do
    patch :update, id: @evento, evento: { contenido: @evento.contenido, titulo: @evento.titulo, usuario_id: @evento.usuario_id }
    assert_redirected_to evento_path(assigns(:evento))
  end
